  ...
  "",
  {
    variants: {
      ...
      size: {
        ...
        body32: "md:text-[32px] md:leading-[40px]",
        body20: "md:text-[20px] md:leading-[28px]",
        body16: "md:text-[16px] md:leading-[24px]",
        body14: "md:text-[14px] md:leading-[22px]",
        body12: "md:text-[12px] md:leading-[16px]",
      ...
      mobileSize: {
        ...
        body32: "text-[32px] leading-[40px]",
        body20: "text-[20px] leading-[28px]",
        body16: "text-[16px] leading-[24px]",
        body14: "text-[14px] leading-[22px]",
        body12: "text-[12px] leading-[16px]",
